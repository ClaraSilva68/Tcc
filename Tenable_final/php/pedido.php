 ...
 <div class="background">
    ...
    <header class="header">
			...
			<form>
				...
				<label for="password">INFORME A QUANTIDADE</label>
				<input type="number" name="password" style="width:410px">
							<span ></span><br> <br>
				
				<a href="compra2.php">				
				<input type="button" value="Comprar"><br><br> <br><br>
				
				
				<p>Quer comprar mais? <a href="peças.html">Veja nossos produtos</a>.</p>
