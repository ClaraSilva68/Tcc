			...
			<div class="row">
				...
				<form  action="incluir.php" method="post">				
					...
					<div class="col-md-6 ">
							...
							<label><b>CPF :</label></b>
							<input name="cpf" type="text" id="cpf"  placeholder= "xxx.xxx.xxx/xx" maxlength="11" onblur="valida()"/> <br>
							
							<label><b>RG  :</label></b>
							<input type="text" name="rg" ><br>
							
							<label><b>Nome :</label></b>
					...
					<div class="col-md-6 ">
						...
						<div class="col-md-4 ">
								...
								<button><a href="listarcliente.php" class="btn btn-success">Editar</a></button>
