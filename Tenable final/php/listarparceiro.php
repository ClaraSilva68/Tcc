...
$query_select_parceiro="SELECT * FROM parceiro";
$sql_select_parceiro=mysqli_query($conexao,$query_select_parceiro);

if($sql_select_parceiro == false)
	{
...
<div class="table-responsive-sm">
 <table class="table table-striped table-info table-hover fixed">
  ...
  <thead>    
  <tr>
    <td><b><font color="red">CNPJ:</font></b></td>
    <td><b><font color="red">Nome Fantasia:</font></b></td>    
    <td><b><font color="red">Razão Social:</font></b></td>
	<td><b><font color="red">Descrição:</font></b></td>
...
<?php  
if(mysqli_num_rows($sql_select_parceiro) > 0)
{
   while($array_select_parceiro=mysqli_fetch_array($sql_select_parceiro))
	{
		$id_parceiro=$array_select_parceiro["id_parceiro"];
		$cnpj=$array_select_parceiro["cnpj"];
		$nomeFantasia=$array_select_parceiro["nomeFantasia"];		
		$razaoSocial=$array_select_parceiro["razaoSocial"];
		$descricao=($array_select_parceiro["descricao"]);
		$telefone=$array_select_parceiro["telefone"];
		$email=$array_select_parceiro["email"];
		$endereco=$array_select_parceiro["endereco"];
		$cidade=$array_select_parceiro["cidade"];		
 ...
 " <tbody>
   <tr>
    ...
    <td>$endereco</td>
    <td>$cidade</td>
	<td><a href=\"editar_parceiro.php?id_parceiro=$id_parceiro\" class='btn btn-dark'>Editar</a></td>
	<td><a href=\"deletar_parceiro.php?id_parceiro=$id_parceiro\"class='btn btn-dark'>Deletar</a></td>
  </tr>
  </tbody>
  ";
	}
